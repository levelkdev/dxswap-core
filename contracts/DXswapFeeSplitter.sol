...
contract DXswapFeeSplitter {
    ...
    function setMaxSwapPriceImpact(uint16 _maxSwapPriceImpact) external {
        ...
        require(_maxSwapPriceImpact > 0 && _maxSwapPriceImpact < 10000, 'DXswapFeeSplitter: FORBIDDEN_PRICE_IMPACT');
    ...
    function setFeePercentageToExternalReceiver(address _pair, uint16 _feePercentageToExternalReceiver) external {
        ...
        require(swapPair.balanceOf(address(this)) == 0, 'DXswapFeeSplitter: TOKENS_NOT_BURNED');
